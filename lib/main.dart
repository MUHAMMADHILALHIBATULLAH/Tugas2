    ...
    Widget kontener() {
      return Container(
        ...
        decoration: BoxDecoration(
            color: Color.fromARGB(255, 192, 8, 216), borderRadius: BorderRadius.circular(15)),
        child: Column(
          children: [
            Row(
      ...
      home: Scaffold(
        body: SafeArea(
          ...
          children: [
            ...
            Column(
              children: [
                teks('Nama Lengkap', 'Rian Hidayaulah'),
                SizedBox(
                  height: 2,
                ),
                Divider(
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Kp Pabuaran Semper Desa Giri Mulya Kec. Cibungbulang Kabupaten Bogor, Jawa Barat',
                        style: empat,
                      ),
                    ],
                  ),
